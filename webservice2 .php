...
if($search_param==""||$search_area==""){
    echo '<div class="text">Please Enter Correct Details!</div>';
return 0;
}
...
if(isset($_POST["search"]) && isset($_POST["area"])){
    ...
    // echo $search_area; 
$host= "localhost";
$dbuser= "id20399379_careforyou";
$dbpass= "Password@123";
$dbname= "id20399379_doctordb";
...
if($result->num_rows > 0)
{
    ...
    while($row = $result->fetch_assoc()){
        ...
        <img class="circle1-icon" alt="" src="public/circle1.svg" />
        <img class="searchlogo-icon" alt=""
        src="'.$doctorimg.'" />
        <div class="findthe-best names">'.$doctorname.'</div>
        <div class="findthe-best">'.$doctorinfo.'</div></div>';
    }
    ...
    $data = '<div class="text">Bad Query...</div>';
}
echo $data;
?>